...
1.    [WebMCU-AI](https://github.com/webmcu-ai) train and run a vision classification model from the web using webSerial and the XIAO ML Kit. The online version [https://webmcu-ai.github.io/webmcu-vision-web/index.html](https://webmcu-ai.github.io/webmcu-vision-web/index.html) also the PWA version allows offline use [https://webmcu-ai.github.io/webmcu-vision-pwa/index.html](https://webmcu-ai.github.io/webmcu-vision-pwa/index.html)
1.  Important with webMCU-AI to try the other firmware.ino machine learning models on your XIAO-ML Kit or serial monitor only XIAO esp32s3 Sense  [WebMCU-AI](https://github.com/webmcu-ai). All these ML models: Vision:classification, FOMO, anomaly, regression, sound and motion need to be trained on device with a micro SD card to store the data, then slowly trained on device, then do inference on device. If a web training page was available it would be much faster to train.
