...
1. **Base03-Blink:** Get the Blink program working using the Arduino IDE and your microcontroller, which means you will need to install the correct board and identify the PORT. Note: I use a blink program that also shows analog read A0 to the Serial Monitor [here](https://github.com/hpssjellis/maker100-eco/blob/main/README.md#a03)
